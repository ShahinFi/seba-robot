...
#define ACTUATOR_DEFAULT_KP_MV_PER_A     4000L
#define ACTUATOR_DEFAULT_KI_MV_PER_A_S      0L
#define ACTUATOR_DEFAULT_INTEGRAL_MV     1000L
#define ACTUATOR_DEFAULT_MAX_CURRENT_MA   2000L
#define ACTUATOR_DEFAULT_MAX_COMMAND      30
